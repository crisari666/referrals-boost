export const twilioSegment = {
  es: {
    ...
    noInternationalNumber: "No tienes un número internacional asignado. Contacta al administrador.",
  ...
  en: {
    ...
    noInternationalNumber: "No international number assigned. Contact your administrator.",
